...
class RegisterPage extends React.Component {
    ...
    render() {
        ...
        return (
            ...
            <style> {'body {background-color: #2D3238;}'} </style>
                <form name="form" onSubmit={this.handleSubmit} style={{marginTop: '70%'}}>
                    ...
                    <div className={'form-group' + (submitted && !user.username ? ' has-error' : '')}>
                        <input type="text" className="form-control" name="username" placeholder="Email" value={user.username} onChange={this.handleChange} />
                    ...
                    <div className="form-group">
                        <button className="btn btn-block"  style={{backgroundColor: '#EA4B8B'}} 
                        >Register</button>
                        
                        <text>
                            <style> {'text {color: #FFFFFF;}'} </style>
                            Already registered!
                        <Link to="/login" className="btn btn-link" style={{color: 'white'}}>Login me</Link> 
                        </text>
